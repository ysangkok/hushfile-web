	...
	xhr.onload = function(e) {
		...
		try {
			...
			if (responseobject.status=='ok') {
				...
				// download url prefix
				url = window.location.protocol + '//' + window.location.host + '/?f=';
				document.getElementById('response').innerHTML = '<p><i class="icon-check"></i> <b><span style="color: green;">Success! Your URL is:</span></b><br> <a class="btn btn-success" href="/?f='+responseobject.fileid+'#'+document.getElementById('password').value+'">'+url+responseobject.fileid+'#'+document.getElementById('password').value+'</a>';
			} else {
